execute store success score #condition noi.math run attribute @s minecraft:gravity modifier remove noi_gravity
execute if score #condition noi.math matches 0 run data modify entity @s NoGravity set value 0b
