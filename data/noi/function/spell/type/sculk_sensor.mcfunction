effect give @s[distance=..1.6201] darkness 14
effect give @e[distance=..1.5,limit=1,sort=nearest,type=!marker] darkness 14
...
particle entity_effect{color:[.161,.153,.129,1.00]} ~ ~ ~ 0 0 0 1 10 normal
