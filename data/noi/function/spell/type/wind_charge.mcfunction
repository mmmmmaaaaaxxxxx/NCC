function noi:math/block_launch {speed:.4}
$data modify storage temp:local macro merge value {UUID:$(UUID)}
data modify storage temp:local macro merge value {type:"wind_charge"}
