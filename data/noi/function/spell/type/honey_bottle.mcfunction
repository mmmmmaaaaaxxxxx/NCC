effect clear @s[distance=..1.6201] poison
effect clear @s[distance=..1.6201] wither
effect clear @e[distance=..1.5,limit=1,sort=nearest,type=!marker] poison
effect clear @e[distance=..1.5,limit=1,sort=nearest,type=!marker] wither
...
playsound minecraft:item.honey_bottle.drink player @a[distance=..4] ~ ~ ~