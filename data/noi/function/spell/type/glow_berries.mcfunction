effect give @s[distance=..1.6201] glowing 45
effect give @e[distance=..1.5,limit=1,sort=nearest,type=!marker] glowing 45
...
particle entity_effect{color:[.580,.627,.380,1.00]} ~ ~ ~ 0 0 0 1 10 normal
