effect give @s[distance=..1.6201] poison 8 0
effect give @e[distance=..1.5,limit=1,sort=nearest,type=!marker] poison 8 0
...
particle entity_effect{color:[.529,.639,.388,1.00]} ~ ~ ~ 0 0 0 1 10 normal
