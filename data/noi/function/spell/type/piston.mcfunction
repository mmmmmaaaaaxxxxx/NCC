playsound block.piston.extend player @a[distance=..10] ~ ~ ~
...
execute as @a[tag=current] run function player_motion:api/launch_looking
execute as @e[type=!player,tag=current] unless score @s noi.cooldown matches 1.. run function noi:spell/extra/launch_facing {strength:"1.8"}
