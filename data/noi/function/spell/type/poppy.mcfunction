effect give @s[distance=..1.6201] night_vision 5
effect give @e[distance=..1.5,limit=1,sort=nearest,type=!marker] night_vision 5
...
particle entity_effect{color:[.761,1.0,.4,1.00]} ~ ~ ~ 0 0 0 1 10 normal
