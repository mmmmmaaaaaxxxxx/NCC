execute store result score #random noi.math run random value 0..1
execute if score #random noi.math matches 0 summon minecraft:goat run tag @s add current
execute if score #random noi.math matches 1 summon minecraft:mooshroom run tag @s add current
