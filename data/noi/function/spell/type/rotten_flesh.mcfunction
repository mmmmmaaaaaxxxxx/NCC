effect give @s[distance=..1.6201] hunger 15 1 false
effect give @e[distance=..1.5,limit=1,sort=nearest,type=!marker] hunger 15 1 false
...
particle entity_effect{color:[.345,.463,.325,1.00]} ~ ~ ~ 0 0 0 1 10 normal
