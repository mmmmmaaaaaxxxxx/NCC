effect give @s[distance=..1.6201] fire_resistance 4 0
effect give @e[distance=..1.5,limit=1,sort=nearest,type=!marker] fire_resistance 4 0
...
particle entity_effect{color:[1.0,0.6,0.0,1.00]} ~ ~ ~ 0 0 0 1 10 normal
