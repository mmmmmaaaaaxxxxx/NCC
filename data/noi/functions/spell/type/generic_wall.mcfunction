$execute positioned ^-3 ^ ^ run fill ~ ~-1 ~ ~ ~3 ~ $(1) replace #noi:place_through
$execute positioned ^-2 ^ ^ run fill ~ ~-1 ~ ~ ~3 ~ $(1) replace #noi:place_through
$execute positioned ^-1 ^ ^ run fill ~ ~-1 ~ ~ ~3 ~ $(1) replace #noi:place_through
$execute positioned ^0 ^ ^ run fill ~ ~-1 ~ ~ ~3 ~ $(1) replace #noi:place_through
$execute positioned ^1 ^ ^ run fill ~ ~-1 ~ ~ ~3 ~ $(1) replace #noi:place_through
$execute positioned ^2 ^ ^ run fill ~ ~-1 ~ ~ ~3 ~ $(1) replace #noi:place_through
$execute positioned ^3 ^ ^ run fill ~ ~-1 ~ ~ ~3 ~ $(1) replace #noi:place_through
