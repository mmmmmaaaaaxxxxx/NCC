effect give @s[distance=..1.6201] levitation 5
effect give @e[distance=..1.5,limit=1,sort=nearest,type=!marker] levitation 5
...
particle entity_effect{color:[.808,1.0,1.0,1.0]} ~ ~ ~ 0 0 0 1 10 normal
