summon creeper ~ ~ ~ {ExplosionRadius:1b,Fuse:0,ignited:1b}
scoreboard players add count noi.lifetime 1
#I actually have no idea what this line is but im kinda scared to remove it ^
