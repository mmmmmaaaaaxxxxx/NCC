effect give @s[distance=..1.6201] conduit_power 30 0 true
effect give @e[distance=..1.5,limit=1,sort=nearest,type=!marker] conduit_power 30 0 true
...
playsound minecraft:block.conduit.activate player @a[distance=..4]