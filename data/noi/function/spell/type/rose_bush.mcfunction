effect give @s[distance=..1.6201] invisibility 10 0 false
effect give @e[distance=..1.5,limit=1,sort=nearest,type=!marker] invisibility 10 0 false
...
particle entity_effect{color:[.965,.965,.965,1.00]} ~ ~ ~ 0 0 0 1 10 normal
