effect give @s[distance=..1.6201] regeneration 8
effect give @e[distance=..1.5,limit=1,sort=nearest,type=!marker] regeneration 8
...
particle entity_effect{color:[.804,.361,.671,1.00]} ~ ~ ~ 0 0 0 1 10 normal
