...
execute if score #random noi.math matches 0 summon minecraft:sheep run tag @s add current
execute if score #random noi.math matches 1 summon minecraft:cow run tag @s add current
