effect give @s[distance=..1.6201] infested 20 0
effect give @e[distance=..1.5,limit=1,sort=nearest,type=!marker] infested 20 0
...
particle minecraft:infested ~ ~ ~ 0 0 0 1 10 normal
