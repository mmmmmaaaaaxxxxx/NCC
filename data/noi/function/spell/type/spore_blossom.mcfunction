effect give @s[distance=..1.6201] water_breathing 5
effect give @e[distance=..1.5,limit=1,sort=nearest,type=!marker] water_breathing 5
...
particle entity_effect{color:[.596,.855,.753,1.00]} ~ ~ ~ 0 0 0 1 10 normal
