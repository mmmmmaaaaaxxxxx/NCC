effect give @s[distance=..1.6201] weaving 60 0
effect give @e[distance=..1.5,limit=1,sort=nearest,type=!marker] weaving 60 0
...
particle minecraft:item_cobweb ~ ~ ~ 0 0 0 1 10 normal
