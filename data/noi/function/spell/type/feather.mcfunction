#chest and piston code combined
...
execute as @s[type=player] rotated as @e[type=marker,tag=current,limit=1] run function player_motion:api/launch_looking
execute as @s[type=!player] rotated as @e[type=marker,tag=current,limit=1] run function noi:spell/extra/launch_facing {strength:"1.8"}
...
playsound minecraft:entity.chicken.hurt player @a[distance=..4] ~ ~ ~