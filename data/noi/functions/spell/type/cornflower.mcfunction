effect give @e[distance=..1.5,limit=1,sort=nearest,type=!marker] jump_boost 6 10
...
particle entity_effect{color:[.992,1.0,.518,1.00]} ~ ~ ~ 0 0 0 1 10 normal
particle entity_effect ~ ~ ~ 0.992 1.000 0.518 1 0 normal
particle entity_effect ~ ~ ~ 0.992 1.000 0.518 1 0 normal
particle entity_effect ~ ~ ~ 0.992 1.000 0.518 1 0 normal
particle entity_effect ~ ~ ~ 0.992 1.000 0.518 1 0 normal
particle entity_effect ~ ~ ~ 0.992 1.000 0.518 1 0 normal
...
particle entity_effect ~ ~ ~ 0.992 1.000 0.518 1 0 normal
particle entity_effect ~ ~ ~ 0.992 1.000 0.518 1 0 normal
playsound minecraft:block.sculk_sensor.clicking player @a[distance=..4] ~ ~ ~
