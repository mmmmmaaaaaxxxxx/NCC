...
execute if entity @s[type=player] store result score $x delta.api.launch run data get entity @s Motion[0] -15000
execute if entity @s[type=player] store result score $y delta.api.launch run data get entity @s Motion[1] -8000
execute if entity @s[type=player] store result score $z delta.api.launch run data get entity @s Motion[2] -15000

execute if entity @s[type=player] run tp @s @s
execute if entity @s[type=player] at @s run function delta:api/launch_xyz
