...
#Dispenser randomizes the order of spells that come after it
#It would be completely unreasonable to simulate every possibility, so I simply won't
#This will surely not cause any major issues in the future!
...
scoreboard players operation mana_cost noi.math /= #4 noi.math
