effect give @s[distance=..1.6201] slowness 6 2
effect give @e[distance=..1.5,limit=1,sort=nearest,type=!marker] slowness 6 2
...
particle entity_effect{color:[.545,.686,.878,1.00]} ~ ~ ~ 0 0 0 1 10 normal
