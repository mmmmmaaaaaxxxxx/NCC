#reverse gravity
attribute @s minecraft:generic.gravity modifier remove noi_gravity
attribute @s minecraft:generic.gravity modifier add noi_gravity -2 add_multiplied_total
...
playsound minecraft:entity.experience_orb.pickup player @s ~ ~ ~ 1 1.7