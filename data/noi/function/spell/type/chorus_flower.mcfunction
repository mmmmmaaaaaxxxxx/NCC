...
execute rotated as @e[type=marker,tag=current,limit=1] positioned ^ ^ ^10 run tp ~ ~ ~
kill @e[tag=current] 
execute positioned as @s run tp @s ~ ~ ~ ~ ~
playsound entity.enderman.teleport player @a[distance=..11] ~ ~ ~
