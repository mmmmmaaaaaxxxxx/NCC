effect give @s[distance=..1.6201] wither 4 3
effect give @e[distance=..1.5,limit=1,sort=nearest,type=!marker] wither 4 3
...
particle entity_effect{color:[.451,.380,.337,1.00]} ~ ~ ~ 0 0 0 1 10 normal
