effect give @s[distance=..1.6201] mining_fatigue 60 0
effect give @e[distance=..1.5,limit=1,sort=nearest,type=!marker] mining_fatigue 60 0
...
particle entity_effect{color:[0.290,0.259,0.090,1.00]} ~ ~ ~ 0 0 0 1 10 normal
