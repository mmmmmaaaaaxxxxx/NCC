execute summon minecraft:chicken run tag @s add current

summon zombie ~ ~ ~ {IsBaby:true,Tags:["current2"]}
...
#chicken jockey!
playsound minecraft:music_disc.lava_chicken master @a[distance=..64] ~ ~ ~ .01 2