effect give @s[distance=..1.6201] weakness 9
effect give @e[distance=..1.5,limit=1,sort=nearest,type=!marker] weakness 9
...
particle entity_effect{color:[.282,.302,.282,1.00]} ~ ~ ~ 0 0 0 1 10 normal
