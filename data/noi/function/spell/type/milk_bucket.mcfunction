effect clear @s[distance=..1.6201]
effect clear @e[distance=..1.5,limit=1,sort=nearest,type=!marker]
...
particle entity_effect{color:[1.000,1.000,1.000,1.00]} ~ ~ ~ 0 0 0 1 10 normal
playsound minecraft:item.bottle.fill player @a[distance=..4] ~ ~ ~