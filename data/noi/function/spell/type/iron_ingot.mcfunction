effect give @s[distance=..1.6201] resistance 1 4
effect give @e[distance=..1.5,limit=1,sort=nearest,type=!marker] resistance 1 4
...
playsound minecraft:item.armor.equip_iron player @a[distance=..4] ~ ~ ~