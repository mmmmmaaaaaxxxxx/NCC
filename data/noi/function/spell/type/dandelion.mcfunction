effect give @s[distance=..1.6201] saturation 5 0
effect give @e[distance=..1.5,limit=1,sort=nearest,type=!marker] saturation 5 0
...
particle entity_effect{color:[.973,.141,.137,1.00]} ~ ~ ~ 0 0 0 1 10 normal
playsound minecraft:entity.player.burp player @a[distance=..4] ~ ~ ~
