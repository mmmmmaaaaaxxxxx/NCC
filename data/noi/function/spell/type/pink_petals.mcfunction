effect give @s[distance=..1.6201] slow_falling 1
effect give @e[distance=..1.5,limit=1,sort=nearest,type=!marker] slow_falling 1
...
particle entity_effect{color:[.953,.812,.725,1.00]} ~ ~ ~ 0 0 0 1 10 normal
