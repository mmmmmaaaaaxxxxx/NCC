effect give @s[distance=..1.6201] absorption 12 1
effect give @e[distance=..1.5,limit=1,sort=nearest,type=!marker] absorption 12 1
...
particle entity_effect{color:[.145,.322,.647,1.00]} ~ ~ ~ 0 0 0 1 10 normal
