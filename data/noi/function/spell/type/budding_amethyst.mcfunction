...
attribute @s generic.scale modifier add noi_scale 7 add_multiplied_total
attribute @s player.entity_interaction_range modifier add noi_scale 7 add_multiplied_total
attribute @s player.block_interaction_range modifier add noi_scale 7 add_multiplied_total
#sqrt(8)-1 to maintain a consistent jump height ratio
attribute @s generic.jump_strength modifier add noi_scale 1.8284 add_multiplied_total
attribute @s generic.step_height modifier add noi_scale 7 add_multiplied_total
attribute @s generic.movement_speed modifier add noi_scale 7 add_multiplied_total
