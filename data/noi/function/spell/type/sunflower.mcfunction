effect give @s[distance=..1.6201] speed 15 2
effect give @e[distance=..1.5,limit=1,sort=nearest,type=!marker] speed 15 2
...
particle entity_effect{color:[.2,.922,1.0,1.00]} ~ ~ ~ 0 0 0 1 10 normal
