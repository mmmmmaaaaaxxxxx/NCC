loot spawn ~ ~ ~ mine ~ ~ ~ shears[enchantments={"minecraft:silk_touch":1}]
execute unless block ~ ~ ~ barrier run setblock ~ ~ ~ air replace
...
playsound minecraft:block.stone.break player @a[distance=..8] ~ ~ ~